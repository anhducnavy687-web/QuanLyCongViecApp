      ...
      body: ResponsivePage(
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Hồ sơ tham gia (${assignments.length})',
              ...
              ...assignments.map((a) {
                ...
                return Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '${a.role.isEmpty ? "Cộng tác" : a.role} • '
